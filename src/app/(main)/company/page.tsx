    ...
    <div className="min-h-screen">
      ...
      <section data-theme="light" className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h1 className="text-5xl sm:text-6xl md:text-7xl leading-tight mb-6 hero-headline text-[#111111]">
            Built on Principle
          </h1>
      ...
      {/* Methodology - Dark */}
      <section id="methodology" data-theme="dark" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#111111]">
        <div className="max-w-7xl mx-auto">
