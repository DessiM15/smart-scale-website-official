...
const notices = (
  ...
  autoOn: "Automatic sending is on. Drafts preview to the team on the 1st and go to clients on the 2nd unless skipped.",
  autoOff: "Automatic sending is off. Drafts wait for you to press Send.",
  ...
  billLoggedInvoice: `Paid${detail ? `: ${detail}` : ""}. It's in the ledger with the invoice filed on it.`,
  billLoggedNoFile: `Paid${detail ? `: ${detail}` : ""}. The row is in, but the invoice wasn't kept; attach it on the row.`,
  billStatementEnough: "Noted: the statement is the record for this bill. Its rows won't ask for an invoice.",
  billInvoiceExpected: "Noted: this bill expects an invoice each month. Add it when you tap Paid.",
...
const errors = (clash?: string, detail?: string): Record<string, string> => ({
  ...
  settings: "The setting could not be saved. The database did not answer.",
