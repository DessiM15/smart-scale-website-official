...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      results: [
        "Direct in-site booking via an embedded StyleSeat flow, with no separate system to manage",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      results: [
        ...
        "Rewarded-ads-only monetization, with no banners and no interstitials",
