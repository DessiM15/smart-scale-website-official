...
const clientLogos = [
  ...
  { name: "Gulf Coast Alloys", src: "/assets/client-logos/gulf-coast-alloys.png", size: "large" as const },
  ...
  { name: "Bloxify", src: "/assets/client-logos/bloxify.png", size: "large" as const },
