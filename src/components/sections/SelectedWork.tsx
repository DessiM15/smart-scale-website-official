...
export default function SelectedWork() {
  // Six: the projects Dessi wants seen first (2026-09-21), three rows of
  // two. The hero already scrolls the whole body of work, so this stops
  // there rather than repeating the portfolio grid a screen later.
